...
public class ItemCategoriesController(ISender sender) : ControllerBase
{
    ...
    /// <summary>L?y danh sách danh m?c v?t ph?m có phân trang.</summary>
    [HttpGet]
    ...
    /// <summary>L?y toàn b? danh m?c v?t ph?m (không phân trang, dùng cho dropdown).</summary>
    [HttpGet("all")]
    ...
    /// <summary>[Metadata] Danh sách mã danh m?c v?t ph?m.</summary>
    [HttpGet("codes")]
    ...
    /// <summary>Xem chi ti?t danh m?c v?t ph?m theo mã code.</summary>
    [HttpGet("code/{code}")]
    ...
    /// <summary>Xóa danh m?c v?t ph?m.</summary>
    [HttpDelete("{id}")]
