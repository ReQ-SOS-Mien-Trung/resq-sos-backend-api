...
public static class LogisticsSeeder
{
    ...
    private static void SeedReliefItems(ModelBuilder modelBuilder)
    {
        ...
        var items = new[]
        {
            ...
            // -- Category 3: Y tế (Medical) - 23 items (tiêu hao, cấp phát cho nạn nhân) --
            ...
            // -- Thuốc mới thêm cho cứu trợ lũ lụt ---------------------------
            new ReliefItem { Id = 111, CategoryId = 3, Name = "Thuốc tiêu chảy Loperamide",      Description = "Cực kỳ cần vì nước bẩn dễ gây tiêu chảy cấp", Unit = "viên",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.005m,  WeightPerUnit = 0.002m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740573/111-thuoc-tieu-chay_lped8m.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 112, CategoryId = 3, Name = "Thuốc trị nhiễm khuẩn đường ruột Smecta", Description = "Bảo vệ niêm mạc ruột, dùng phổ biến cho trẻ em", Unit = "gói",   ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.02m,   WeightPerUnit = 0.015m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740573/112-thuoc-tri-nhiem-khuan-duong-ruot_b4kl8t.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 113, CategoryId = 3, Name = "Thuốc chống nôn Domperidone",     Description = "Hữu ích khi ngộ độc thực phẩm, say nước", Unit = "viên",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.005m,  WeightPerUnit = 0.002m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740575/113-thuoc-chong-non_arfxgw.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 114, CategoryId = 3, Name = "Thuốc cảm cúm tổng hợp Decolgen",  Description = "Giảm triệu chứng cảm lạnh do thời tiết ẩm ướt", Unit = "viên",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.005m,  WeightPerUnit = 0.002m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740575/114-thuoc-cam-cum-tong-hop_ut7ikb.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 115, CategoryId = 3, Name = "Thuốc ho Dextromethorphan",       Description = "Ho do nhiễm lạnh, viêm họng", Unit = "viên",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.005m,  WeightPerUnit = 0.002m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740574/115-thuoc-ho_tau9qj.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 116, CategoryId = 3, Name = "Thuốc long đờm Acetylcysteine",   Description = "Giúp thông đường hô hấp", Unit = "gói",   ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.02m,   WeightPerUnit = 0.015m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740574/116-thuoc-long-dom_cehf8e.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 117, CategoryId = 3, Name = "Thuốc chống dị ứng Loratadine",   Description = "Rất cần trong môi trường nhiều muỗi, côn trùng", Unit = "viên",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.005m,  WeightPerUnit = 0.002m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740574/117-thuoc-chong-di-ung-con-trung-dot_h4u5ni.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 118, CategoryId = 3, Name = "Kem bôi ngoài da Hydrocortisone", Description = "Dùng cho viêm da, ngứa, phát ban", Unit = "tuýp",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.08m,   WeightPerUnit = 0.05m,   ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740576/118-kem-boi-ngoai-da_kob7vt.png", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 119, CategoryId = 3, Name = "Thuốc chống nấm da Clotrimazole", Description = "Quan trọng vì ngâm nước lâu dễ bị nấm", Unit = "tuýp",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.08m,   WeightPerUnit = 0.05m,   ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740573/119-thuoc-chong-nam-da_gbm5gz.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 120, CategoryId = 3, Name = "Thuốc giảm đau kháng viêm Ibuprofen", Description = "Dùng khi chấn thương nhẹ, đau cơ", Unit = "viên",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.005m,  WeightPerUnit = 0.002m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740573/120-thuoc-giam-dau-khang-viem_clmacb.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 121, CategoryId = 3, Name = "Thuốc nhỏ mắt (viêm kết mạc)",  Description = "Điều trị viêm kết mạc do nước bẩn", Unit = "chai",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.05m,   WeightPerUnit = 0.04m,   ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740576/121-thuoc-nho-mat_bikoag.png", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 122, CategoryId = 3, Name = "Thuốc nhỏ mũi (nghẹt mũi do lạnh)", Description = "Giảm nghẹt mũi do thời tiết lạnh", Unit = "chai",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.05m,   WeightPerUnit = 0.04m,   ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740573/122-thuoc-nho-mui_tiyq2x.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 123, CategoryId = 3, Name = "Vitamin C liều cao",              Description = "Tăng cường sức đề kháng", Unit = "viên",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.005m,  WeightPerUnit = 0.002m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740573/123-vitamin-c-lieu-cao_ih25mo.jpg", CreatedAt = now, UpdatedAt = now },
            new ReliefItem { Id = 124, CategoryId = 3, Name = "Thuốc chống say nước",            Description = "Dành cho đội cứu hộ khi làm việc trên nước", Unit = "viên",  ItemType = ItemType.Consumable.ToString(), VolumePerUnit = 0.005m,  WeightPerUnit = 0.002m,  ImageUrl = "https://res.cloudinary.com/dezgwdrfs/image/upload/v1777740573/124-thuoc-chong-say-nuoc_cnzzjb.jpg", CreatedAt = now, UpdatedAt = now },
    ...
    private static void SeedItemModelTargetGroups(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("item_model_target_groups").HasData(
            ...
            // Sữa hộp trẻ em – chỉ dành cho trẻ
    ...
    private static void SeedSupplyInventoryLots(ModelBuilder modelBuilder)
    {
        ...
        var lots = new List<SupplyInventoryLot>
        {
            ...
            new() { Id = 34, SupplyInventoryId = 3,  Quantity = 30000, RemainingQuantity = 30000, ReceivedDate = new DateTime(2026, 1, 8, 8, 0, 0, DateTimeKind.Utc), ExpiredDate = new DateTime(2028, 1, 8, 0, 0, 0, DateTimeKind.Utc), SourceType = InventorySourceType.DepotFund.ToString(), SourceId = 1, CreatedAt = new DateTime(2026, 1, 8, 8, 0, 0, DateTimeKind.Utc) },
            // Log 42: Invoice 3, dầu gió, Feb 2026
            new() { Id = 35, SupplyInventoryId = 7,  Quantity = 500,   RemainingQuantity = 500,   ReceivedDate = new DateTime(2026, 2, 12, 10, 0, 0, DateTimeKind.Utc), ExpiredDate = new DateTime(2029, 2, 12, 0, 0, 0, DateTimeKind.Utc), SourceType = InventorySourceType.DepotFund.ToString(), SourceId = 1, CreatedAt = new DateTime(2026, 2, 12, 10, 0, 0, DateTimeKind.Utc) },
    ...
    private static void SeedInventoryLogs(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InventoryLog>().HasData(
            ...
            new InventoryLog { Id = 13, DepotSupplyInventoryId = 49, SupplyInventoryLotId = 13, ActionType = InventoryActionType.Import.ToString(), QuantityChange = 6400,   SourceType = InventorySourceType.Donation.ToString(), SourceId = 7,  PerformedBy = mgr2, Note = "Nhập sữa hộp kho Đà Nẵng",                     ReceivedDate = now, ExpiredDate = exp06, CreatedAt = now },
            ...
            new InventoryLog { Id = 26, DepotSupplyInventoryId = 137, SupplyInventoryLotId = 26, ActionType = InventoryActionType.Import.ToString(), QuantityChange = 7200,  SourceType = InventorySourceType.Donation.ToString(), SourceId = 10, PerformedBy = mgr4, Note = "Nhập sữa hộp kho trung ương",                  ReceivedDate = now, ExpiredDate = exp06, CreatedAt = now },
