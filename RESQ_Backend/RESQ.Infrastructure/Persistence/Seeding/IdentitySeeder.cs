...
public static class IdentitySeeder
{
    ...
    private static void SeedUsers(ModelBuilder modelBuilder)
    {
        ...
        var users = new List<User>
        {
            ...
            new User
            {
                Id = SeedConstants.Manager6UserId,
                RoleId = 4,
                FirstName = "Minh Hiếu",
                LastName = "Lý",
                Username = "manager6",
                Email = "manager6@resq.vn",
                Phone = "0934567895",
                Password = SeedConstants.ManagerPasswordHash,
                Address = "88 Lê Duẩn",
            ...
            new User
            {
                Id = SeedConstants.Manager7UserId,
                RoleId = 4,
                FirstName = "Thị Lan Anh",
                LastName = "Đặng",
                Username = "manager7",
                Email = "manager7@resq.vn",
                Phone = "0934567896",
                Password = SeedConstants.ManagerPasswordHash,
                Address = "15 Nguyễn Trãi",
                Ward = "Phường Trường Thi",
                Province = "Nghệ An",
                IsEmailVerified = true,
                CreatedAt = now,
                UpdatedAt = now
        ...
        for (int i = 1; i <= 80; i++)
        {
            ...
            users.Add(new User
            {
                ...
                RoleId = 3,
                FirstName = $"{dem[(i - 1) % dem.Length]} {ten[(i - 1) % ten.Length]}",
                LastName = ho[(i - 1) % ho.Length],
                Username = $"rescuer{i}",
                Phone = $"09{i:D8}",
