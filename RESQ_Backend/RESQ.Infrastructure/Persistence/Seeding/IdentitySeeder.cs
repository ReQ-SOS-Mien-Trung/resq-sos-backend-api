    ...
    private static void SeedUsers(ModelBuilder modelBuilder)
    {
        ...
        var users = new List<User>
        {
            ...
            new User
            {
                ...
                Phone = "0912345678",
                Email = "lan.tran@resq.vn",
                Password = SeedConstants.CoordinatorPasswordHash,
                Address = "45 Trần Phú, TP. Huế",
            ...
            new User
            {
                ...
                Username = "manager",
                Phone = "0934567890",
                Email = "hang.pham@resq.vn",
                Password = SeedConstants.ManagerPasswordHash,
                Address = "46 Điện Biên Phủ, Quận 1",
            ...
            new User
            {
                ...
                Username = "manager2",
                Phone = "0934567891",
                Email = "binh.nguyen@resq.vn",
                Password = SeedConstants.ManagerPasswordHash,
                Address = "10 Ông Ích Khiêm, Hải Châu",
                Province = "Đà Nẵng",
                IsEmailVerified = true,
                IsOnboarded = true,
                IsEligibleRescuer = true,
            ...
            new User
            {
                ...
                Username = "manager3",
                Phone = "0934567892",
                Email = "thao.tran@resq.vn",
                Password = SeedConstants.ManagerPasswordHash,
                Address = "02 Phan Đình Phùng, TP. Hà Tĩnh",
                Province = "Hà Tĩnh",
                IsEmailVerified = true,
                IsOnboarded = true,
                IsEligibleRescuer = true,
            ...
            new User
            {
                ...
                Username = "manager4",
                Phone = "0934567893",
                Email = "khoa.dang@resq.vn",
                Password = SeedConstants.ManagerPasswordHash,
                Address = "01 Tôn Đức Thắng, TP. Huế",
                Province = "Thừa Thiên Huế",
                IsEmailVerified = true,
                IsOnboarded = true,
                IsEligibleRescuer = true,
            ...
            new User
            {
                ...
                Address = "23 Nguyễn Huệ, Phú Nhuận",
                Province = "TP. Hồ Chí Minh",
                IsEmailVerified = true,
                IsOnboarded = true,
                IsEligibleRescuer = true,
        ...
        var firstNames = new[] { "Minh", "Hùng", "Thắng", "Tuấn", "Dũng", "Phúc", "Long", "Đạt", "Hoàng", "Khải",
                                 "Linh", "Hà", "Trang", "Ngọc", "Thủy", "Phương", "Hiền", "Hạnh", "Yến", "Trinh" };
        var lastNames = new[] { "Nguyễn Văn", "Trần Thị", "Lê Văn", "Phạm Thị", "Hoàng Văn",
