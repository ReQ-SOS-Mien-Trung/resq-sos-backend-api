        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    note = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    safety_latest_checkin_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    safety_timeout_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    safety_status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    generated_sos_request_id = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
