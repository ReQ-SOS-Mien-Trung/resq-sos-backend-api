...
public partial class SupplyInventory
{
    ...
    [InverseProperty(nameof(DepotClosureTransferConsumableReservation.SupplyInventory))]
    ...
    [InverseProperty(nameof(DepotSupplyRequestConsumableReservation.SupplyInventory))]
