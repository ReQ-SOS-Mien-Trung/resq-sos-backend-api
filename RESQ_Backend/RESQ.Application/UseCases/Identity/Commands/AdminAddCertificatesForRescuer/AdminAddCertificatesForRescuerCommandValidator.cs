...
{
    public class AdminAddCertificatesForRescuerCommandValidator : AbstractValidator<AdminAddCertificatesForRescuerCommand>
    {
        public AdminAddCertificatesForRescuerCommandValidator()
        {
            RuleFor(x => x.UserId)
