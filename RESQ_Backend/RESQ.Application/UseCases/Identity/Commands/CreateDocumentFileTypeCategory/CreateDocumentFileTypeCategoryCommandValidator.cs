...
public class CreateDocumentFileTypeCategoryCommandValidator : AbstractValidator<CreateDocumentFileTypeCategoryCommand>
{
    public CreateDocumentFileTypeCategoryCommandValidator()
    {
        RuleFor(x => x.Code)
