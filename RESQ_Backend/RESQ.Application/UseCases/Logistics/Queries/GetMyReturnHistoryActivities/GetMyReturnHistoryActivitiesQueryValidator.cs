...
public class GetMyReturnHistoryActivitiesQueryValidator : AbstractValidator<GetMyReturnHistoryActivitiesQuery>
{
    public GetMyReturnHistoryActivitiesQueryValidator()
    {
