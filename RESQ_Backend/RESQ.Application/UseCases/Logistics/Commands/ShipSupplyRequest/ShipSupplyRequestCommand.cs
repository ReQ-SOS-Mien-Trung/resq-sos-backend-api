...
// ── Response ──────────────────────────────────────────────────────────────────
public class ShipSupplyRequestResponse
{
...
// ── Handler ───────────────────────────────────────────────────────────────────
/// <summary>
/// Kho nguồn xuất hàng (TransferOut) và chuyển trạng thái sang Shipped.
    ...
    : IRequestHandler<ShipSupplyRequestCommand, ShipSupplyRequestResponse>
{
    public async Task<ShipSupplyRequestResponse> Handle(ShipSupplyRequestCommand request, CancellationToken cancellationToken)
    {
        ...
        await supplyRequestRepository.UpdateStatusAsync(sr.Id, "Shipped", "InTransit", null, cancellationToken);
