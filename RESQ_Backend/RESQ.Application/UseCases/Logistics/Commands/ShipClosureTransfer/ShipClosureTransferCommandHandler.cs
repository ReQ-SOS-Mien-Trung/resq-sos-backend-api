...
/// <summary>
/// Quản lý kho nguồn xác nhận đã xuất hàng → chuyển transfer sang Shipping.
    ...
    : IRequestHandler<ShipClosureTransferCommand, ShipClosureTransferResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Transition: AwaitingShipment → Shipping (domain validates)
        transfer.MarkShipped(request.UserId, request.Note);
        ...
        return new ShipClosureTransferResponse
        {
            ...
            Message = "Đã xác nhận xuất hàng. Kho đích đang được thông báo để chuẩn bị nhận hàng."
        };
    }
}
