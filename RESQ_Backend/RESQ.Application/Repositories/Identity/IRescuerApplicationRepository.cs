...
namespace RESQ.Application.Repositories.Identity
{
    public interface IRescuerApplicationRepository
    {
        ...
        Task<PagedResult<RescuerApplicationDto>> GetPagedAsync(int pageNumber, int pageSize, string? status = null, string? name = null, string? email = null, string? phone = null, CancellationToken cancellationToken = default);
