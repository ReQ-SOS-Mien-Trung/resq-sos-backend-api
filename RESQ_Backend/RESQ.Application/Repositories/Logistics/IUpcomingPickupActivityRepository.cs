...
public class UpcomingPickupActivityListItem
{
    ...
    public List<UpcomingPickupItemDetail> Items { get; set; } = [];
}

public class PickupHistoryActivityListItem
{
    public int DepotId { get; set; }
    public string? DepotName { get; set; }
...
public class UpcomingPickupItemDetail
{
