...
public class MissionActivityStatusExecutionServiceTests
{
    ...
    private sealed class RecordingAssemblyEventRepository : IAssemblyEventRepository
    {
        ...
        public Task<PagedResult<CheckedInRescuerDto>> GetCheckedInRescuersByAssemblyPointAsync(int assemblyPointId, int pageNumber, int pageSize, RescuerType? rescuerType = null, string? abilitySubgroupCode = null, string? abilityCategoryCode = null, string? search = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
