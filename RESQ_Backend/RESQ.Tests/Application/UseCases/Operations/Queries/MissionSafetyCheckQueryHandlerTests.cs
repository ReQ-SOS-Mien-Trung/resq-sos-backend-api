...
public class MissionSafetyCheckQueryHandlerTests
{
    ...
    private sealed class StubSosRequestUpdateRepository : ISosRequestUpdateRepository
    {
        ...
        public Task<IReadOnlyDictionary<int, SosRequestVictimUpdateModel>> GetLatestVictimUpdatesBySosRequestIdsAsync(IEnumerable<int> sosRequestIds, CancellationToken cancellationToken = default) => Task.FromResult<IReadOnlyDictionary<int, SosRequestVictimUpdateModel>>(new Dictionary<int, SosRequestVictimUpdateModel>());
