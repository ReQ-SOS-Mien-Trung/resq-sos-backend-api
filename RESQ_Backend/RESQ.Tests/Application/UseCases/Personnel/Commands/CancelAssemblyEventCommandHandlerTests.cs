...
public class CancelAssemblyEventCommandHandlerTests
{
        ...
        List<Guid> participantIds) : IAssemblyEventRepository
    {
        ...
        public Task<(int EventId, int AssemblyPointId, string Status, DateTime AssemblyDate, DateTime? CheckInDeadline)?> GetLatestCheckedInEventForRescuerAtAssemblyPointAsync(int assemblyPointId, Guid rescuerId, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        ...
        public Task<RESQ.Application.Common.Models.PagedResult<RESQ.Application.UseCases.Personnel.Queries.GetCheckedInRescuers.CheckedInRescuerDto>> GetCheckedInRescuersByAssemblyPointAsync(int assemblyPointId, int pageNumber, int pageSize, RESQ.Domain.Enum.Identity.RescuerType? rescuerType = null, string? abilitySubgroupCode = null, string? abilityCategoryCode = null, string? search = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
