...
public class CreateRescueTeamCommandHandlerTests
{
        ...
        Dictionary<int, HashSet<Guid>> checkedInUsersByEvent) : IAssemblyEventRepository
    {
        ...
        public Task<PagedResult<RESQ.Application.UseCases.Personnel.Queries.GetCheckedInRescuers.CheckedInRescuerDto>> GetCheckedInRescuersByAssemblyPointAsync(int assemblyPointId, int pageNumber, int pageSize, RescuerType? rescuerType = null, string? abilitySubgroupCode = null, string? abilityCategoryCode = null, string? search = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
    ...
    private sealed class NoOpAdminRealtimeHubService : IAdminRealtimeHubService
    {
        ...
        public Task PushMissionExecutionProgressUpdateAsync(RESQ.Application.Common.Models.AdminMissionExecutionProgressRealtimeUpdate update, CancellationToken cancellationToken = default) => Task.CompletedTask;
